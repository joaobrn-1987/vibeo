  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "w-full max-w-lg bg-white rounded-2xl shadow-hover border border-cream-200 p-6",
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 rounded-lg p-1 text-foreground/40 hover:text-foreground hover:bg-cream-100 transition-colors">
        <X className="h-4 w-4" />
      </DialogClose>
    </DialogPrimitive.Content>
  </DialogPortal>
